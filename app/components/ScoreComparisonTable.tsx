              ...
              <thead>
                <tr className="bg-gradient-to-r from-[#fc5d01] to-[#ff7e3f]">
                  ...
                  {scores.map((score, index) => (
                    <th 
                      key={index} 
                      className="min-w-[78px] sm:min-w-[88px] py-3 sm:py-5 px-2 sm:px-3 text-sm sm:text-lg md:text-xl font-bold text-white text-center whitespace-nowrap leading-none tracking-tight border-r border-orange-400 last:border-r-0"
                    >
                      {score.pte}
                    </th>
                  ))}
